import {  VirtualizedList, View, PixelRatio, RefreshControl } from 'react-native';
...
export default function HomeScreen() {
  ...
  const fetchSecrets = async (params = '', abortController: any) => {
    try {
  ...
  useEffect(() => {
    ...
    fetchSecrets(`?page=${page}&limit=${limit}&sort=${sort}${sex}${age}${secondaryage}${nsfw}${estate}&decrypt=true&select=+title,+slug,+text,+password,+age,+sex,+state,+nsfw,+deletable,+commented,+tags,+status,+createdAt,+updatedAt`, abortController);
